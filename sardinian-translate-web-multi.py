    ...
    while True:
        ...
        if os.path.exists(audio_file) and os.path.getsize(audio_file) > 5000:
            ...
            try:
                ...
                try:
                    # Try Sardinian first (you can change this to auto)
                    # Note: Google may have limited support for Sardinian
                    text = recognizer.recognize_google(audio_data, language="sc")
